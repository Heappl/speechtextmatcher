...
def createStats(checked, target, errorThresholds):
    ...
    aveStartDiff /= len(checked)
    aveEndDiff /= len(checked)
...
#(585, 1.3542329999999936, 0.03297232435897484, 0.03197732649572708, 0.03396732222222261, {0.5: 9, 1: 2, 0.4: 10, 0.2: 19, 0.05: 66, 0.3: 15, 0.1: 34}, {0.5: 0, 1: 0, 0.4: 0, 0.2: 0, 0.05: 0, 0.3: 0, 0.1: 0}, {0.5: 8, 1: 2, 0.4: 11, 0.2: 26, 0.05: 78, 0.3: 18, 0.1: 42}, {0.5: 1, 1: 0, 0.4: 1, 0.2: 1, 0.05: 21, 0.3: 1, 0.1: 5}, {0.5: 16, 1: 4, 0.4: 20, 0.2: 44, 0.05: 132, 0.3: 32, 0.1: 73}, {0.5: 4, 1: 1, 0.4: 4, 0.2: 5, 0.05: 28, 0.3: 5, 0.1: 10})
